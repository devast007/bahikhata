...
class DialogFragmentTransactionFilter : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        mBottomSheetDialog.findViewById<Button>(R.id.btn_filter_ok)
            ...
            RadioGroup.OnCheckedChangeListener { group, checkedId ->
                ...
                when (checkedId) {
                    R.id.rb_receiver -> {
                        ...
                        for (item in transactionViewActivity!!.mUsersMap) {
                    ...
                    R.id.rb_work -> {
                        mFilter = FILTER_WORK
                        for (item in transactionViewActivity!!.mProjectsMap) {
                            currentFilterArrayList.add(item)
                        }
                    }
                }
        ...
        titleSearchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String): Boolean {
                ...
                when (mFilter) {
                    FILTER_SENDER, FILTER_RECIEVER -> tempMap =
                        transactionViewActivity!!.mUsersMap
                    FILTER_WORK -> tempMap = transactionViewActivity!!.mProjectsMap
                }
                if (tempMap != null) {
                    for (item in tempMap) {
    ...
    inner class FilterAdapter() : BaseAdapter() {
        private var mInflater: LayoutInflater =
            transactionViewActivity!!.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
